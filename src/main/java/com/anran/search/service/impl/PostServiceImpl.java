...
import com.anran.search.model.entity.PostFavour;
import com.anran.search.model.entity.PostThumb;
...
import com.anran.search.utils.SqlUtils;
...
public class PostServiceImpl extends ServiceImpl<PostMapper, Post> implements PostService {
    ...
    public Page<Post> searchFromEs(PostQueryRequest postQueryRequest) {
        ...
        // 查出结果后，从 db 获取最新动态数据（比如 帖子点赞数、收藏数）
